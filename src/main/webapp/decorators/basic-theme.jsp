			...
			<ul class="nav navbar-nav" id="headerTop">
				...
				<%-- <li class="dropdown" >
					<a  style="text-decoration: none;" 
						...
						aria-expanded="false" id="btn_notif" 
						data-toggle="tooltip" data-placement="right" >
						title="<spring:message code="warning.appointment" />"
						Notification <span class="caret"></span>
					</a>
					<ul class="dropdown-menu" >
						<li class="dropdown-submenu" >
	              			<a tabindex="-1" href="#">No Inform Appointment</a>
	              			<ul class="dropdown-menu" >
	            		...
	            		<li class="dropdown-submenu" >
	              			<a tabindex="-1" href="#">No Inform Changed Appointment</a>
	              			<ul class="dropdown-menu" >
