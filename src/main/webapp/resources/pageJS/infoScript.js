...
//		   	----------------------------------	
				...
				var $informationApplicant = $('#informationApplicant').validate({
					...
					invalidHandler: function(event, validator) {
				 		var errors = $informationApplicant.numberOfInvalids();
				 	    if (errors) {
				 	    	$informationApplicant.errorList[0].element.focus(); //Set Focus
				 	    }
					}
				});
