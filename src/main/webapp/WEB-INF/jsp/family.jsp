...
<!-- 						<div class="form-inline"> -->
				<div class="form-group">
					...
					<input type="text" class="form-control" id="age" name="age" placeholder="<spring:message code="info.text.age"/>">
				</div>
				<div class="form-group">
					<label for="gender"><spring:message code="info.sex" /></label> 
					<input type="text" class="form-control" id="gender" name="gender" placeholder="<spring:message code="family.text.name"/>">
				</div>
<!-- 						</div> -->
				<div class="form-group">
					<label for="telNo"><spring:message code="ref.tel" /></label> 
					<input type="text" class="form-control" id="telNo" name="telNo" placeholder="<spring:message code="ref.text.tel"/>">
				</div>
				<div class="form-group">
